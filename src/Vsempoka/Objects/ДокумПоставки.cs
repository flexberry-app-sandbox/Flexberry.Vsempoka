...
namespace IIS.Vsempoka
{
    ...
    public class ДокумПоставки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Vsempoka.DetailArrayOfТЧИнфОЗаказе fТЧИнфОЗаказе;
        ...
        public virtual IIS.Vsempoka.DetailArrayOfТЧИнфОЗаказе ТЧИнфОЗаказе
        {
            get
            {
                ...
                {
                    this.fТЧИнфОЗаказе = new IIS.Vsempoka.DetailArrayOfТЧИнфОЗаказе(this);
                }
                IIS.Vsempoka.DetailArrayOfТЧИнфОЗаказе result = this.fТЧИнфОЗаказе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиE", typeof(IIS.Vsempoka.ДокумПоставки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставкиL", typeof(IIS.Vsempoka.ДокумПоставки));
                }
            }
        }
    }
